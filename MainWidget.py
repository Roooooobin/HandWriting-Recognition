...
class Ui_mainWidget(object):
    def setupUi(self, mainWidget):
        ...
        self.resutLineEdit.setObjectName("resutLineEdit")
        ...
        self.algorithmCombo.addItem("")
        self.algorithmCombo.addItem("")
        self.objectCombo = QtWidgets.QComboBox(mainWidget)
        self.objectCombo.setGeometry(QtCore.QRect(805, 120, 120, 26))
        self.objectCombo.setObjectName("objectCombo")
        self.objectCombo.addItem("")
        self.objectCombo.addItem("")
        self.objectCombo.addItem("")
    ...
    def retranslateUi(self, mainWidget):
        ...
        self.resutLineEdit.setPlaceholderText(_translate("mainWidget", "识别结果"))
        ...
        self.objectCombo.setItemText(0, _translate("mainWidget", "数字"))
        self.objectCombo.setItemText(1, _translate("mainWidget", "字母"))
        self.objectCombo.setItemText(2, _translate("mainWidget", "数字+字母"))
