...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.run.setGeometry(QtCore.QRect(310, 360, 71, 21))
        self.run.setObjectName("run")
        self.output = QtWidgets.QTextBrowser(Form)
        self.output.setGeometry(QtCore.QRect(130, 20, 431, 251))
        self.output.setObjectName("output")
        self.model_name = QtWidgets.QTextEdit(Form)
        self.model_name.setGeometry(QtCore.QRect(170, 300, 111, 41))
        self.model_name.setObjectName("model_name")
        self.image_path = QtWidgets.QTextEdit(Form)
        self.image_path.setGeometry(QtCore.QRect(290, 300, 111, 41))
        self.image_path.setObjectName("image_path")
        self.target_name = QtWidgets.QTextEdit(Form)
        self.target_name.setGeometry(QtCore.QRect(410, 300, 101, 41))
        self.target_name.setObjectName("target_name")

        self.retranslateUi(Form)
        self.run.clicked.connect(self.run.click)
